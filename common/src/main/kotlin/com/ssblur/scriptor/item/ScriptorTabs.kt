...
object ScriptorTabs {
    ...
    val SCRIPTOR_TAB: RegistrySupplier<CreativeModeTab> = TABS.register(ResourceLocation.tryBuild(MOD_ID, "scriptor_tab")) {
        CreativeTabRegistry.create(Component.translatable("itemGroup.scriptor.scriptor_tab")) { ItemStack(ScriptorItems.TOME_TIER4.get()) }
    }
    val SCRIPTOR_SPELLBOOKS_TAB: RegistrySupplier<CreativeModeTab> = TABS.register(ResourceLocation.tryBuild(MOD_ID, "scriptor_spellbooks")) {
        CreativeTabRegistry.create(Component.translatable("itemGroup.scriptor.scriptor_spellbooks")) { ItemStack(ScriptorItems.SPELLBOOK.get()) }
    }
