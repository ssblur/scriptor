...
class NearbyMobsCastingCrystal(properties: Properties): CasterCrystal(properties) {
  override fun getTargetables(itemStack: ItemStack?, level: Level?, caster: Targetable): List<Targetable?> {
    return level
      ?.getEntitiesOfClass(Mob::class.java, AABB.ofSize(caster.targetPos, 8.0, 8.0, 8.0))
  ...
  override fun appendHoverText(
    ...
    list.add(Component.translatable("lore.scriptor.mob_crystal").withStyle(ChatFormatting.GRAY))
