...
object Words {
    data class Word(val cost: Int, val castAtPosition: List<String>, val castOnEntity: List<String>, val castOnItem: List<String>)
    init {
        ScriptorMod.registerDataLoader("scriptor/actions", Word::class) { word, location ->
            ...
            register(
                ...
                CommandAction(word.cost.toDouble(), word.castAtPosition.toTypedArray(), word.castOnEntity.toTypedArray(), word.castOnItem.toTypedArray())
            )
        }
    }
}